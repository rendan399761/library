<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="借书时间" prop="jieshushijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jieshushijian" label="借书时间" prop="jieshushijian">
              <el-input v-model="ruleForm.jieshushijian" 
                placeholder="借书时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
