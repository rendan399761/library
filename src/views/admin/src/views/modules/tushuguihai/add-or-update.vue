<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="借阅号" prop="jieyuehao">
...
export default {
  ...
  methods: {
      ...
      this.$http({
		...
		if(json.shenfenzheng!=''&&json.shenfenzheng){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/tushujieyue/jieyuehao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
    ...
    jieyuehaoChange () {
      this.$http({
        url: `follow/tushujieyue/jieyuehao?columnValue=`+ this.ruleForm.jieyuehao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
